              ...
              child: Column(
                children: [
                  Obx(() => SwitchListTile(
                        ...
                        onChanged: (value) =>
                            controller.requireEmailVerification.value = value,
                        activeColor: AppTheme.primary,
                      )),
                  const Divider(height: 1),
                  Obx(() => SwitchListTile(
                        title: const Text('Two-factor authentication (Coming Soon)'),
                        ...
                        trailing: SizedBox(
                          ...
                          child: DropdownButton<int>(
                            ...
                            items: [15, 30, 60, 120]
                                ...
                                .toList(),
                            onChanged: (value) =>
                                controller.sessionTimeout.value = value!,
                          ),
                        ),
                      )),
                  const Divider(height: 1),
                          ...
                          child: DropdownButton<int>(
                            ...
                            items: [3, 5, 10]
                                .map((val) => DropdownMenuItem(
                                    value: val, child: Text('')))
                                .toList(),
                            onChanged: (value) =>
                                controller.maxLoginAttempts.value = value!,
                          ),
                        ),
                      )),
                ],
              ...
              child: Column(
                children: [
                  Obx(() => SwitchListTile(
                        ...
                        subtitle:
                            const Text('Send email notifications to users.'),
                  ...
                  const Divider(height: 1),
                  Obx(() => SwitchListTile(
                        title: const Text('SMS notifications (Coming Soon)'),
                        subtitle:
                            const Text('Send SMS notifications to users.'),
              ...
              child: Column(
                children: [
                  Obx(() => SwitchListTile(
                        ...
                        onChanged: (val) =>
                            controller.autoApproveRegistrations.value = val,
                        activeColor: AppTheme.primary,
                      )),
                ],
              ),
              ...
              child: Column(
                children: [
                  Obx(() => SwitchListTile(
                        ...
                        subtitle:
                            const Text('Put the system into maintenance mode.'),
                        value: controller.maintenanceMode.value,
                        onChanged: (val) =>
                            controller.maintenanceMode.value = val,
                        activeColor: AppTheme.warning,
                      )),
                  const Divider(height: 1),
                  ListTile(
                    leading:
                        const Icon(Icons.clear_all, color: AppTheme.warning),
                  ...
                  ListTile(
                    ...
                    title: const Text('Backup database (Railway Managed)'),
                    subtitle: const Text('Backups are handled by the hosting provider.'),
