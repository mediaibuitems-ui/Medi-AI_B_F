...
out += '*In plain terms:* The local memory box on your phone that remembers who you are so you don\\'t have to login every time.\n\n';
...
out += '*In plain terms:* Making sure long paragraphs of text don\\'t break the edges of tiny mobile screens.\n\n';
...
out += '*In plain terms:* Taking out the garbage when you leave a room so the phone doesn\\'t slow down.\n\n';

fs.writeFileSync('Frontend_Architecture_Guide.md', out);
console.log('Frontend Architecture Guide generated successfully.');
